...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("""
                To check this magnificent game - enter next commands:
                'exit' - to get the hell out
                'replay' - obviously for starting again
                'castling0' or 'castling7' - don't know what it means ether...i'm not Magnus Carlsen
                'move 1 1 2 3' - just try something like that, it should be fine, i guess""");
        System.out.println();
        board.printBoard();
        while (true) {
